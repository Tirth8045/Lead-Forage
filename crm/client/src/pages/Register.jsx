          ...
          <div className="border-0 shadow-lg" style={{
            ...
            <div className="p-5">
              ...
              <form ref={formRef} noValidate onSubmit={handleSubmit} className={`needs-validation ${validated ? 'was-validated' : ''}`}>
                <div className="mb-3">
                  <label htmlFor="regName" className="form-label small" style={{ fontFamily: 'Manrope, sans-serif', letterSpacing: '-0.03em' }}>
                    Full Name
                  </label>
                  <input
                    id="regName"
                ...
                <div className="mb-3">
                  <label htmlFor="regEmail" className="form-label small" style={{ fontFamily: 'Manrope, sans-serif', letterSpacing: '-0.03em' }}>
                    Email
                  </label>
                  <input
                    id="regEmail"
                ...
                <div className="mb-3">
                  <label htmlFor="regAdminCode" className="form-label small" style={{ fontFamily: 'Manrope, sans-serif', letterSpacing: '-0.03em' }}>
                    Admin Code <span className="fw-normal" style={{ color: '#64748B' }}>(optional)</span>
                  </label>
                  <input
                    id="regAdminCode"
                    type="password"
                    ...
                    className="form-control"
                    style={{ fontFamily: 'Manrope, sans-serif', fontSize: '14px' }}
                    placeholder="Leave blank for sales account"
                  />
                </div>

                <div className="mb-4">
                  <label htmlFor="regPassword" className="form-label small" style={{ fontFamily: 'Manrope, sans-serif', letterSpacing: '-0.03em' }}>
                    Password
                  </label>
                  <input
                    id="regPassword"
