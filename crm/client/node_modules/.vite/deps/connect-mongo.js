...
import { r as require_browser_external_buffer } from "./parseurl-wOFTe-cP.js";
import { t as require_express_session } from "./express-session-C-C3MiJ-.js";
import { t as require_browser_external_crypto } from "./browser-external_crypto-DKAnmfw8.js";
import { t as require_lib } from "./lib-B3YKfzI4.js";
import { n as require_inherits_browser, r as require_browser, t as require_safer } from "./safer-CvDFD_ix.js";
//#region browser-external:node:assert/strict
var require_strict = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = Object.create(new Proxy({}, { get(_, key) {
		if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") console.warn(`Module "node:assert/strict" has been externalized for browser compatibility. Cannot access "node:assert/strict.${key}" in client code. See https://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`);
	} }));
}));
//#endregion
...
//#endregion
//#region ../../server/node_modules/bn.js/lib/bn.js
...
//#endregion
//#region ../../server/node_modules/asn1.js/lib/asn1/base/reporter.js
...
//#endregion
//#region ../../server/node_modules/asn1.js/lib/asn1/base/buffer.js
var require_buffer = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	DecoderBuffer.isDecoderBuffer = function isDecoderBuffer(data) {
		...
		return typeof data === "object" && Buffer.isBuffer(data.base) && data.constructor.name === "DecoderBuffer" && typeof data.offset === "number" && typeof data.length === "number" && typeof data.save === "function" && typeof data.restore === "function" && typeof data.isEmpty === "function" && typeof data.readUInt8 === "function" && typeof data.skip === "function" && typeof data.raw === "function";
	};
	...
	EncoderBuffer.isEncoderBuffer = function isEncoderBuffer(data) {
		...
		return typeof data === "object" && data.constructor.name === "EncoderBuffer" && typeof data.length === "number" && typeof data.join === "function";
	};
...
//#endregion
//#region ../../server/node_modules/minimalistic-assert/index.js
...
//#endregion
//#region ../../server/node_modules/asn1.js/lib/asn1/base/node.js
var require_node = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	Node.prototype._decode = function decode(input, options) {
		...
		if (present) {
			...
			if (state.any) {} else if (state.choice === null) result = this._decodeGeneric(state.tag, input, options);
	...
	Node.prototype._encodeValue = function encode(data, reporter, parent) {
		...
		if (state.optional && data === void 0) if (state["default"] !== null) data = state["default"];
		else return;
		let content = null;
		let primitive = false;
...
//#endregion
//#region ../../server/node_modules/asn1.js/lib/asn1/constants/der.js
var require_der$2 = /* @__PURE__ */ __commonJSMin(((exports) => {
...
//#endregion
//#region ../../server/node_modules/asn1.js/lib/asn1/encoders/der.js
var require_der$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var inherits = require_inherits_browser();
	var Buffer = require_safer().Buffer;
	var Node = require_node();
	var der = require_der$2();
...
//#endregion
//#region ../../server/node_modules/asn1.js/lib/asn1/encoders/pem.js
var require_pem$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var inherits = require_inherits_browser();
	var DEREncoder = require_der$1();
...
//#endregion
//#region ../../server/node_modules/asn1.js/lib/asn1/encoders/index.js
var require_encoders = /* @__PURE__ */ __commonJSMin(((exports) => {
	var encoders = exports;
	encoders.der = require_der$1();
	encoders.pem = require_pem$1();
}));
//#endregion
//#region ../../server/node_modules/asn1.js/lib/asn1/decoders/der.js
...
//#endregion
//#region ../../server/node_modules/asn1.js/lib/asn1/decoders/pem.js
var require_pem = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var inherits = require_inherits_browser();
	var Buffer = require_safer().Buffer;
	var DERDecoder = require_der();
...
//#endregion
//#region ../../server/node_modules/asn1.js/lib/asn1/decoders/index.js
var require_decoders = /* @__PURE__ */ __commonJSMin(((exports) => {
	var decoders = exports;
	decoders.der = require_der();
	decoders.pem = require_pem();
}));
//#endregion
//#region ../../server/node_modules/asn1.js/lib/asn1/api.js
...
//#endregion
//#region ../../server/node_modules/asn1.js/lib/asn1/base/index.js
...
//#endregion
//#region ../../server/node_modules/asn1.js/lib/asn1/constants/index.js
var require_constants = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	constants.der = require_der$2();
}));
//#endregion
//#region ../../server/node_modules/asn1.js/lib/asn1.js
...
//#endregion
//#region ../../server/node_modules/kruptein/lib/kruptein.js
/*!
* kruptein
* Copyright(c) 2019 Jason Gerfen <jason.gerfen@gmail.com>
* License: MIT
*/
var require_kruptein$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Kruptein = class {
		constructor(options) {
			options = options || {};
			this.crypto = require_browser_external_crypto();
		...
		set(secret, plaintext, aad, cb) {
			...
			if (this._aead_mode && typeof aad === "function") this._digest(this._iv(128), plaintext, this._hashing, this._encodeas, (err, res) => {
		...
		_encrypt(key, pt, algo, encodeas, iv, aad, cb) {
			cb = cb || aad;
			let cipher, ct, at;
			cipher = this.crypto.createCipheriv(algo, key, iv, { authTagLength: this._at_size });
			if (this._aead_mode && typeof aad !== "function") try {
				cipher.setAAD(Buffer.from(aad, encodeas), { plaintextLength: Buffer.byteLength(pt) });
			} catch (err) {
		...
		_decrypt(key, ct, algo, encodeas, iv, at, aad, cb) {
			cb = cb || aad;
			let cipher, pt;
			cipher = this.crypto.createDecipheriv(algo, key, iv, { authTagLength: this._at_size });
			if (this._aead_mode && at) try {
				cipher.setAuthTag(Buffer.from(at, encodeas));
			} catch (err) {
				return cb("Unable to set authentication tag");
			}
			if (this._aead_mode && typeof aad !== "function") try {
				cipher.setAAD(Buffer.from(aad, encodeas), { plaintextLength: ct.length });
			} catch (err) {
		...
		_derive_key(secret, salt, cb) {
			...
			try {
				if (!this._use_scrypt || typeof this.crypto.scryptSync !== "function") key = this.crypto.pbkdf2Sync(secret, salt, 15e3, this._key_size, this._hashing);
				else key = this.crypto.scryptSync(secret, salt, this._key_size, opts);
			} catch (err) {
		...
		_schema() {
			let schema;
			if (!this._aead_mode) schema = this.asn1.define("schema", function() {
				this.seq().obj(this.key("ct").octstr(), this.key("hmac").octstr(), this.key("iv").octstr(), this.key("salt").octstr());
			});
			else schema = this.asn1.define("schema", function() {
...
//#endregion
//#region ../../server/node_modules/kruptein/index.js
var require_kruptein = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/*!
	* kruptein
	* Copyright(c) 2019 Jason Gerfen <jason.gerfen@gmail.com>
	* License: MIT
	*/
	module.exports = require_kruptein$1();
}));
//#endregion
//#region ../../server/node_modules/connect-mongo/dist/index.mjs
var import_strict = /* @__PURE__ */ __toESM(require_strict(), 1);
var import_express_session = /* @__PURE__ */ __toESM(require_express_session(), 1);
var import_lib = require_lib();
var import_browser = /* @__PURE__ */ __toESM(require_browser(), 1);
var import_browser_external_node_util = /* @__PURE__ */ __toESM(require_browser_external_node_util(), 1);
var import_browser_external_node_crypto = require_browser_external_node_crypto();
var import_kruptein = /* @__PURE__ */ __toESM(require_kruptein(), 1);
var defaultCryptoOptions = {
	secret: false,
...
var createKrupteinAdapter = (options) => {
	const merged = {
		...defaultCryptoOptions,
		...options
	};
	if (!merged.secret) throw new Error("createKrupteinAdapter requires a non-empty secret");
	const instance = (0, import_kruptein.default)(merged);
	const encrypt = import_browser_external_node_util.default.promisify(instance.set).bind(instance);
	const decrypt = import_browser_external_node_util.default.promisify(instance.get).bind(instance);
	return {
...
var decodeBytes = (payload, encoding) => {
	switch (encoding) {
...
var createWebCryptoAdapter = ({ secret, ivLength, encoding = "base64", algorithm = "AES-GCM", salt, iterations = 31e4 }) => {
	if (!secret) throw new Error("createWebCryptoAdapter requires a secret");
	const { subtle } = import_browser_external_node_crypto.webcrypto;
	if (!subtle?.decrypt || !import_browser_external_node_crypto.webcrypto?.getRandomValues) throw new Error("Web Crypto API is not available in this runtime");
	...
	return {
		async encrypt(plaintext) {
			...
			const iv = import_browser_external_node_crypto.webcrypto.getRandomValues(new Uint8Array(resolvedIvLength));
...
var debug = (0, import_browser.default)("connect-mongo");
var noop = () => {};
var unit = (a) => a;
...
function computeExpires(session$1, fallbackTtlSeconds) {
	...
	return new Date(Date.now() + fallbackTtlSeconds * 1e3);
}
var MongoStore = class MongoStore extends import_express_session.Store {
	clientP;
	cryptoAdapter = null;
	timer;
	collectionP;
	...
	constructor({ collectionName = "sessions", ttl = 1209600, mongoOptions = {}, autoRemove = "native", autoRemoveInterval = 10, touchAfter = 0, stringify = true, timestamps = false, crypto, cryptoAdapter, ...required }) {
		...
		(0, import_strict.default)(options.mongoUrl || options.clientPromise || options.client, "You must provide either mongoUrl|clientPromise|client in options");
		(0, import_strict.default)(options.createAutoRemoveIdx === null || options.createAutoRemoveIdx === void 0, "options.createAutoRemoveIdx has been reverted to autoRemove and autoRemoveInterval");
		(0, import_strict.default)(!options.autoRemoveInterval || options.autoRemoveInterval <= 71582, "autoRemoveInterval is too large. options.autoRemoveInterval is in minutes but not seconds nor mills");
		...
		let _clientP;
		if (options.mongoUrl) _clientP = import_lib.MongoClient.connect(options.mongoUrl, options.mongoOptions);
		...
		(0, import_strict.default)(!!_clientP, "Client is null|undefined");
